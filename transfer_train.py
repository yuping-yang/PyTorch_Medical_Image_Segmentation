...
from transfer_create_network import get_network
...
def train(args):
    ...
    # produce the network
    checkpoint = args.checkpoint
    net = get_network(properties, task_id, val_output_dir, checkpoint, transfer)
    net = net.to(device)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="transfer learning mode: 0, 1, 2, 3, 4"
             "transfer == 0 (default):"
             ...
             "    Freeze parameters for the loaded input & down-sampling layers while training parameters for all ..."
             "    the other layers")
    parser.add_argument(
        "-amp",
        "--amp",
